...
class PullUpExercise extends StatefulWidget {
  const PullUpExercise({Key? key}) : super(key: key);
  @override
  State<PullUpExercise> createState() => _PullUpExerciseState();
}

class _PullUpExerciseState extends State<PullUpExercise> {
  List timerValue = [
    ['Warm Up', false, 0, 1],
    ['Exercise', false, 0, 1],
    ['Rest', false, 0, 1],
    ['Stretching', false, 0, 1],
  ];
