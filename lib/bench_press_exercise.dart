...
class BenchPressExercise extends StatefulWidget {
  const BenchPressExercise({Key? key}) : super(key: key);
  @override
  State<BenchPressExercise> createState() => _BenchPressExerciseState();
}

class _BenchPressExerciseState extends State<BenchPressExercise> {
  List timerValue = [
    ['Warm Up', false, 0, 1],
    ['Exercise', false, 0, 1],
    ['Rest', false, 0, 1],
